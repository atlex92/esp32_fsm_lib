...
public:
    explicit Fsm(const char* const name, FsmState* const initial_state, const uint32_t period, const uint8_t prio = 1, const uint16_t stack_size = configMINIMAL_STACK_SIZE * 5, const BaseType_t core_id = 0)
